// Full list of countries with ISO codes and flag emojis
...
// Prioritized list - top pilgrim-originating countries first
export const countries: Country[] = [
    // Top pilgrim countries (prioritized at top for common selections)
